...
export default function BookList() {
  ...
  if (filteredBooks.length === 0 && !loading) {
    return (
      <View style={styles.safeContainer}>
        <Text>
          No books found. Try a different search or add a new book to the
          database.
        </Text>
      </View>
    );
              ...
              <View style={styles.details}>
                ...
                <View style={styles.bottomRow}>
                  <Text
                    style={[
                      styles.price,
                      item.price === "Free" && styles.priceFree,
                    ]}
                  >
...
const styles = StyleSheet.create({
  ...
  details: {
    flex: 1,
    marginLeft: 12, // Ensure all children inside here are clean: title, subtitle, bottomRow
  },
  title: {
    fontSize: 16,
    fontWeight: "600",
